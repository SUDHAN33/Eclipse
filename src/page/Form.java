...
public class Form extends JFrame
{
    ...
    Form()
    {
    	...
    	setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\arant\\Downloads\\download (4).png"));
    	setTitle("Login");
...
//        });
       ...
       // b1.setBounds(600, 300, 100, 25);
        ...
        getContentPane().add(l1); getContentPane().add(l2); getContentPane().add(t1); getContentPane().add(t2); getContentPane().add(b2); getContentPane().add(b3);
